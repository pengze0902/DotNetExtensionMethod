...
namespace DapperForNet
{
    ...
    static partial class SqlMapper
    {
        ...
        public partial interface IDynamicParameters
        {
            ...
            /// </summary>
            /// <param name="command">执行前的原始命令</param>
            /// <param name="identity">有关查询的信息</param>
            void AddParameters(IDbCommand command, Identity identity);
        }

        /// <summary>
        ///实现此接口以将任意特定于数据库的参数传递给Dapper
        /// </summary>
        ...
        public interface ITypeMap
        {
            ...
            /// <returns>匹配构造函数或默认值</returns>
            ConstructorInfo FindConstructor(string[] names, Type[] types);

            /// <summary>
            ///获取构造函数参数的映射
            /// </summary>
            /// <param name="constructor">构造器来解决</param>
            /// <param name="columnName">DataReader列名称</param>
        ...
        /// <summary>
        /// 这是一个微缓存;合适当的项数是可控的（几百，例如），
        /// 严格追加只; 您不能更改现有值。 所有关键匹配都在** REFERENCE **上
        /// 平等。 类型是完全线程安全的。
        /// </summary>
        ...
        public partial class Identity : IEquatable<Identity>
        {
            ...
            /// <summary>
            /// 创建用于与DynamicParameters一起使用的标识，仅供内部使用
            /// </summary>
