...
namespace BasicMmethodExtensionClass.IOHelper.StreamHelper.NsStream
{
    ...
    public class ByteBuilder
    {
        ...
        public void Add(byte[] array, int offset, int count)
        {
            ...
            Buffer.BlockCopy(array, offset, _buffer, Length, count);
            Length = newLength;
        }
        ...
        private void ExpandCapacity(int newLength)
        {
            ...
            if (Length > 0)
            {
                Buffer.BlockCopy(_buffer, 0, newBuffer, 0, Length);
            }
            _buffer = newBuffer;
        }
        ...
        {
            Buffer.BlockCopy(_buffer, srcOffset, dstArray, dstOffset, count);
        }             
        ...
        {
            return new ByteRange(_buffer, 0, Length);
        }
        ...
        private class DebugView
        {
            ...
            /// 查看的对象
            /// </summary>
            private readonly ByteBuilder _buidler;
            ...
            public byte[] Values
            {
                get
                {
                    var array = new byte[_buidler.Length];
                    _buidler.CopyTo(array, _buidler.Length);
                    return array;
                }
            }
        }
